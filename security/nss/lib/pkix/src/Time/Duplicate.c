...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/Time/Attic/Duplicate.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:14:33 $ $Name: NSS_CLIENT_TAG $";
#endif /* DEBUG */
