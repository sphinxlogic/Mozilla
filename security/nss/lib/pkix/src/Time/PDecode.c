...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/Time/Attic/PDecode.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:14:34 $ $Name: NSS_CLIENT_TAG $";
#endif /* DEBUG */
